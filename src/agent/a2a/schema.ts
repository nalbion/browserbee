...
import { JSONRPCError, JSONRPCRequest, JSONRPCResponse } from "../mcp/JSONRPC";
 ...
 */
export type SendMessageResponse = JSONRPCResponse<Task | Message, A2AError>;
