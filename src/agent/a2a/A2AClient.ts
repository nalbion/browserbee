// Copied from https://github.com/google/A2A/blob/main/samples/js/src/client/client.ts
import { A2ARequest, AgentCard, CancelTaskRequest, CancelTaskResponse,
  GetTaskPushNotificationRequest, GetTaskPushNotificationResponse, GetTaskRequest, GetTaskResponse,
  JSONRPCError, JSONRPCRequest, JSONRPCResponse,
  SendTaskRequest, SendMessageResponse, SendTaskStreamingRequest, SendTaskStreamingResponse,
  ...
  Message} from "./schema";
// import { AgentCard, A2ARequest, JSONRPCRequest, JSONRPCResponse, JSONRPCError } from "./types";
...
export class A2AClient {
   ...
   */
  async sendMessage(params: MessageSendParams): Promise<Task | Message | null> {
    ...
    const response = await this._handleJsonResponse<SendMessageResponse>(
      httpResponse,
      "message/send"
    );
